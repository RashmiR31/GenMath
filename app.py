...
st.title("Mathematics Question Paper Generator")
...
with st.form(key="question_paper_form"):
    ...
    question_pattern_options = ["MCQ","Reasoning & ASsertion", "Fill in the blanks","Short Answer","Word problems","Numericals"]
...
if submit_button:
    ...
    result = generate_question_paper(grade=selected_class,topic=topic,level=difficulty_level,pattern=question_pattern,no_of_questions=number_of_questions)
    st.write(result)
